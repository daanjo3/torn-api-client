...
export const isTornSelection = (value: string): boolean => tornSelectionList.some(selection => selection === value);

export const tornSelectionList = ((): string[] => Object.values(Selection))();
